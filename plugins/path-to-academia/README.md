...
for the research direction, opportunity type, constraints, geographic scope, exact target venues,
related venue families, honor sources, identity-link sources such as Google Scholar, other
